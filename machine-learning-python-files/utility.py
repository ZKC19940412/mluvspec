...
def transfer_learning_from_pre_train_models(estimator_para_file_path,
                                            ...
                                            ground_truth,
                                            molecule_string):
    """transfer_learning_from_pre_train_models is used to perform transfer-learning from pretrain model
...
def make_estimators(estimator_para_file_path, estimator_base_structure=None):
    ...
    if estimator_base_structure is None:
        # If no base structure is provided, generate a list of base structure with the same lasso models
...
def extract_dataset(data_path, is_extract_pre_train_model=False):
    """extract_dataset is used to extract data set of descriptors and target energies
